...
const SPECIFIC_REPOS: Repo[] = [
  {
    ...
    html_url: 'https://github.com/aswinsivadas-tech/node-rest-api-typescript',
  },
  {
    ...
    html_url: 'https://github.com/aswinsivadas-tech/react-ts-personal-portfolio',
  },
  {
    name: 'RoyalKulture-Ecommerce-WebApp',
    description:
      'RoyalKulture web app is built to deliver a modern e-commerce experience specifically for luxury wSneakers. Users can browse, wishlist, add to cart, and place orders. Admins can manage products, users, and orders with ease.',
    stars: 12,
    forks: 1,
    language: 'Next.js, TypeScript',
    html_url: 'https://github.com/aswinsivadas-tech/RoyalKulture-Ecommerce-WebApp',
  },
];
...
export function GitHub() {
  ...
  useEffect(() => {
    fetch('https://api.github.com/users/aswinsivadas-tech')
      .then(res => res.json())
